...
module.exports.getTcpServerLocalProtocol = async function getTcpServerLocalProtocol (req, res, next, body, uuid) {
  let responseCode = responseCodeEnum.code.OK;
  await TcpServer.getTcpServerLocalProtocol(req.url, body)
      .then(function (response) {
        responseBuilder.buildResponse(res, responseCode, response);
      })
      .catch(function (response) {
...
module.exports.getTcpServerDescription = async function getTcpServerDescription (req, res, next, body, uuid) {
  let responseCode = responseCodeEnum.code.OK;
  await TcpServer.getTcpServerDescription(req.url, body)
      .then(function (response) {
        responseBuilder.buildResponse(res, responseCode, response);
      })
      .catch(function (response) {
